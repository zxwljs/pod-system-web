...
export const DEFAULT_SITE_SETTINGS = {
  ...
  icpNumber: '',
  // 客户端下载页用：飞书文档（含安装包 + 教程）与备用直链
  // 正式安装包地址由「软件版本」模块统一发布，前端自动同步，无需在此填写
  feishuDownloadUrl: 'https://gcn2ovxcjfar.feishu.cn/docx/F17dd1eLeoDyKpxHZxHcARf3n2b?from=from_copylink',
  clientFallbackDownloadUrl: '',
};
