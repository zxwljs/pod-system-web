...
import TemplateDesignerDev from './components/TemplateEditorV2Dev'
...
const TABS = ['intro', 'templates', 'templates-v2', 'patterns', 'tools', 'results', 'tasks', 'designer', 'designer-dev', 'settings']
...
function App() {
  ...
  if (activeTab === 'designer-dev') {
    return <TemplateDesignerDev />
  }
